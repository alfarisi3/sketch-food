...
@section('page-heading', 'Edit Food')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="title" name="title" rows="3" placeholder="Enter title">{{ $food->title }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter description">{{ $food->description }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="price" name="price"
                                    class="form-control @error('price') is-invalid @enderror" placeholder="Enter Price" value="{{ $food->price }}">
                                @error('price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('picture') is-invalid @enderror" type="file"
                                    name="picture" id="picture"> <img src="{{ asset('img/food/' . $food->picture) }}" alt="{{ $food->title }}" style="margin-top: 10px; border-radius: 5px;" class="rounded-square" width="80"
                                    height="100">
