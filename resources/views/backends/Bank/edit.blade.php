                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="bank_name" name="bank_name"
                                    class="form-control @error('bank_name') is-invalid @enderror" placeholder="Enter Bank_name" value="{{ $bank->bank_name }}">
                                @error('bank_name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="bank_account_number" name="bank_account_number"
                                    class="form-control @error('bank_account_number') is-invalid @enderror" placeholder="Enter Bank_account_number" value="{{ $bank->bank_account_number }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="account_name" name="account_name"
                                    class="form-control @error('account_name') is-invalid @enderror" placeholder="Enter Account_name" value="{{ $bank->account_name }}">
                                @error('account_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="mb-3">
                                ...
                                <img src="{{ asset('img/bank/' . $bank->picture) }}" alt="{{ $bank->title }}" style="margin-top: 10px; border-radius: 5px;" class="rounded-square" width="80" value="{{ $bank->picture }}">
