                ...
                <div class="card">
                    ...
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($banks as $bank)
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('img/bank/' . $bank->picture) }}" alt="image"
                                            ...
                                            <td>
                                                <a href="{{ route('bank.edit', $bank->id) }}" class="btn btn-warning"><i
                        ...
                        <div class="col-12 d-flex justify-content-between mt-3">
                            <div>
                                showing {{ $banks->firstItem() }} to {{ $banks->lastItem() }} of {{ $banks->total() }}
                                entries
                            </div>
                            <div>
                                {{ $banks->links() }}
