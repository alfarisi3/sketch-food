...
@section('page-heading', 'Edit About')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="title" name="title" rows="3" placeholder="Enter title">{{ $about->title }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter description">{{ $about->description }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('picture') is-invalid @enderror" type="file"
                                    name="picture" id="picture"> <img src="{{ asset('img/about/' . $about->picture) }}" alt="{{ $about->title }}" style="margin-top: 10px; border-radius: 5px;" class="rounded-square" width="80"
                                    height="100">
